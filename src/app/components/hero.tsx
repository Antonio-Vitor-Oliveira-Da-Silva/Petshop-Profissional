            ...
            <div className="container mx-auto pt-16 pb-16 md:pb-0 px-4 relative">
                ...
                <article className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <h1 className="text-3xl md:text-4xl font-bold loading-10" data-aos="fade-down">
                            Seu pet merece cuidado, carinho & atenção especial.
                        </h1>
                        <p className="lg:text-lg" data-aos="fade-right">
                            ...
                            <a href="https://wa.me/5585985244438" 
                                data-aos="fade-up"
                                dalay-aos-delay="500"
                                target="_blank"
